...
export class CustomerService {
  ...
  getCustomers() {
    return this.http.get('https://3000-dot-4031203-dot-devshell.appspot.com/all');
  }
  deleteRent(id) {
    return this.http.delete('https://3000-dot-4031203-dot-devshell.appspot.com/' + id)
  }
  getDemo(id) {
  ...
  textCustomer(messageAndNum) {
    console.log("coolio");
    return this.http.post('https://3000-dot-4031203-dot-devshell.appspot.com/text', messageAndNum);
  }
}
